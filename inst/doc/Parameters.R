...
## ----eval=FALSE, message=FALSE, include=FALSE, out.width="30%"-----------
...
## ----echo=FALSE, message=FALSE, out.width="30%"--------------------------
...
## ----echo=FALSE, message=FALSE, out.width="22%"--------------------------
...
## ----echo=FALSE, message=FALSE, out.width="16%"--------------------------

...
makeColors <- function(
  ...
  # Allow short form: makeColors(v, parameters)     *** TO BE REPLACED BY S4 ***
  ...
  if(! bypass) {
    ...
    v2c <- function (v, v.a, v.b, c.a, c.b, t.a, t.b, n) {
      i <- floor(n * (v - v.a) / (v.b - v.a)) / (n - 1)
